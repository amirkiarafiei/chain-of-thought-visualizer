  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-6 flex flex-col h-[90vh]">
      ...
      <motion.div
        ...
        className="bg-zinc-800/40 border border-white/20 backdrop-blur-md rounded-xl p-6 mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4"
      >
        <div>
           ...
           <p className="text-white/80 text-lg md:text-xl font-medium pl-14">&quot;{challenge.prompt}&quot;</p>
        </div>
        <Button
            size="lg"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1 min-h-0">
        ...
        {/* Standard Model */}
        <div className="flex flex-col gap-4 bg-white/10 rounded-xl p-4 border border-white/10 h-full overflow-hidden">
            <div className="flex items-center justify-between pb-2 border-b border-white/10">
                <span className="font-semibold text-white/60 uppercase tracking-wider text-sm">Standard Prompting (Baseline)</span>
        ...
        {/* CoT Model */}
        <div className="flex flex-col gap-4 bg-white/10 rounded-xl p-4 border border-white/10 h-full overflow-hidden relative">
